...
USERS_LIMITED = os.getenv("LIMITED_USERS_SHEET")  # ID Google Таблицы для лимитных пользователей
USERS_UNLIMITED = os.getenv("UNLIMITED_USERS_SHEET")  # ID Google Таблицы для безлимитных пользователей
